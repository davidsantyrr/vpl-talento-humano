...
<body>
    <div class="wrapper">
        <div class="card">
            ...
            <div class="content">
                <p class="intro">Estimado/a <strong>{{ $entrega->entrega_user }}</strong>,</p>
                <p class="intro">Se ha registrado exitosamente una nueva entrega en el sistema de Gestión de Talento
                    Humano.</p>

                <div class="info-box">
                    <div class="info-title">Información del Receptor</div>
                    <div class="info-row">
                    ...
                    <div class="info-row">
                        ...
                        <span class="value">{{ \Carbon\Carbon::parse($entrega->created_at)->format('d/m/Y H:i:s')
                            }}</span>
                    </div>
                </div>

                @if(count($elementos) > 0)
                <div class="info-title">Elementos Entregados</div>
                <table>
                    <thead>
                        <tr>
                            <th>#</th>
